<ul class="list-group">
  ...
  <li class="list-group-item">Applications</li>
	  ...
	  <a href="/setting/app/myCp" style="border-top: 0 none;padding-left: 39px;" class="list-group-item">My CP Space</a>
	  <a href="/setting/app/myCp" style="border-top: 0 none;padding-left: 39px;" class="list-group-item">My CP Item</a>
